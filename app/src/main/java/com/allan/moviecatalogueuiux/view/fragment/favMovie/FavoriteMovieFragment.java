package com.allan.moviecatalogueuiux.view.fragment.favMovie;
...
public class FavoriteMovieFragment extends Fragment implements ItemMovieListener {
    ...
    public static class GetFavoriteTask extends AsyncTask<Void, Void, List<Movie>> {
        ...
        GetFavoriteTask(FavoriteMovieFragment fragment) {
