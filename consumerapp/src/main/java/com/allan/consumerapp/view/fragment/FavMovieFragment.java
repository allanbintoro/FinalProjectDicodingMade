...
public class FavMovieFragment extends Fragment implements LoadFavoriteMovieListener {

    private static final String KEY_MOVIES = "movie";
    ...
    private void observeMovieList() {
        mainViewModel.getMovie().observe(getViewLifecycleOwner() , new Observer<List<Movie>>() {
            ...
            public void onChanged(List<Movie> movies) {
                movieAdapter.setMoviesList(MappingHelper.filterfav(movies, KEY_MOVIES));
                tv_no_movie.setVisibility(View.GONE);
